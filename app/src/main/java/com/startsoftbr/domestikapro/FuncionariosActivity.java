    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new FuncionarioAdapter(new ArrayList<>(), new FuncionarioAdapter.OnItemClick() {
            ...
            public void onClick(FuncionarioResponse f) {
                Intent it = new Intent(FuncionariosActivity.this, FuncionarioDetailActivity.class);
        ...
        fabAdd.setOnClickListener(v -> {
            Intent it = new Intent(FuncionariosActivity.this, CadastroFuncionarioActivity.class);
            startActivity(it);
        });
    }
        ...
        api.listar().enqueue(new Callback<List<FuncionarioResponse>>() {
            ...
            public void onResponse(Call<List<FuncionarioResponse>> call, Response<List<FuncionarioResponse>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    Toast.makeText(FuncionariosActivity.this, "Erro ao carregar funcionárias", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<List<FuncionarioResponse>> call, Throwable t) {
                Toast.makeText(FuncionariosActivity.this, "Falha de conexão", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
